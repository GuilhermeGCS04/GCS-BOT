		...
		try {
			...
			switch(command) {
				...
				case 'meme':
					...
					break
			   case 'Oi':
		            if (args.length < 1) return reply ('Ola')
		            break
			    case 'Dono':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://www.google.com/search?q=Thomas+Shelby+&tbm=isch&ved=2ahUKEwiTxJukztruAhVlDtQKHfbpA9cQ2-cCegQIABAC&oq=Thomas+Shelby+&gs_lcp=ChJtb2JpbGUtZ3dzLXdpei1pbWcQAzIFCAAQsQMyBQgAELEDMgUIABCxAzICCAAyBQgAELEDOgQIIxAnOgQIABBDOgcIIxDqAhAnOgQIABADOggIABCxAxCDAToECAAQDVC6TFinlAFgpZkBaAJwAHgDgAH3A4gBkCmSAQkyLTguNS4yLjGYAQCgAQGwAQLAAQE&sclient=mobile-gws-wiz-img&ei=zVkhYNOpGuWc0Ab204-4DQ&bih=612&biw=360&client=ms-android-samsung-gj-rev1&prmd=nimv#imgrc=iu6bU62zs1YOWM`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '*NOME:* Guilherme.gcs\n*WPP:* wa.me/+5577997029532\n*'})
					break
				/*case 'memeindo':
					memein = await kagApi.memeindo()
